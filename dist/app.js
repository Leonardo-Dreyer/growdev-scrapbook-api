...
const Redis_1 = __importDefault(require("./database/connections/Redis"));
...
class Application {
    ...
    routers() {
        ...
        fs_1.default.readdirSync(routesPath).forEach((filename) => {
            Promise.resolve().then(() => __importStar(require(path_1.default.resolve(routesPath, filename)))).then((file) => {
